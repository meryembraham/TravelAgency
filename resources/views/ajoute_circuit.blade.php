...
<div class="tm-container-outer bg-overlay">
        ...
        <div class="row tm-banner-row" id="tm-section-search">
            ...
            <form action="{{url('/ajoute-circuit')}}" method="POST" enctype="multipart/form-data" class="tm-search-form tm-section-pad-2" id="form">
            @csrf    
            <div class="form-row tm-search-form-row">                                
                    ...
                    <div class="form-group tm-form-group tm-form-group-pad tm-form-group-1">
                        ...
                        <input name="description" type="text" class="form-control @error('description') is-invalid @enderror" id="inputCity" placeholder="Tapez Description...">
                        @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="form-group tm-form-group tm-form-group-pad tm-form-group-1">
                        ...
                        <input name="categorie" type="text" class="form-control @error('categorie') is-invalid @enderror" id="inputCity" placeholder="Tapez categorie">
                        @error('categorie')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
